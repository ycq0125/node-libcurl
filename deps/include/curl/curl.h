...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
    ...
    defined(__OpenBSD__) || defined(__CYGWIN__) || defined(AMIGA) || defined(__NuttX__) ||        \
...
typedef int (*curl_progress_callback)(void* clientp, double dltotal, double dlnow, double ultotal,
                                      double ulnow);
...
typedef curl_socket_t (*curl_opensocket_callback)(void* clientp, curlsocktype purpose,
...
typedef int (*curl_prereq_callback)(void* clientp, char* conn_primary_ip, char* conn_local_ip,
...
typedef CURLSTScode (*curl_hstswrite_callback)(CURL* easy, struct curl_hstsentry* e,
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
   ...
   * See
   * https://commondatastorage.googleapis.com/chromium-boringssl-docs/ssl.h.html#SSL_set_permute_extensions.
   */
...
typedef void (*curl_lock_function)(CURL* handle, curl_lock_data data, curl_lock_access locktype,
                                   void* userptr);
